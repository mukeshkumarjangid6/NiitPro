	...
	<div class="container">
		...
		<div id="products" class="row list-group">
			<div class="item  col-xs-4 col-lg-4">
				<div class="thumbnail">
					<img class="group list-group-image" src="${images}/Nature.jpg"
						alt="" />
					<div class="caption">
						<h4 class="group inner list-group-item-heading">Nature</h4>
			...
			<div class="item  col-xs-4 col-lg-4">
				<div class="thumbnail">
					<img class="group list-group-image" src="${images}/Animal.jpg"
						alt="" />
					<div class="caption">
						<h4 class="group inner list-group-item-heading">Animal</h4>
						<p class="group inner list-group-item-text">Product
							description... Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
							laoreet dolore magna aliquam erat volutpat.</p>
			...
			<div class="item  col-xs-4 col-lg-4">
				<div class="thumbnail">
					<img class="group list-group-image" src="${images}/ethnic1.jpg"
						alt="" />
					<div class="caption">
						<h4 class="group inner list-group-item-heading">Ethnic</h4>
						<p class="group inner list-group-item-text">Product
							description... Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
							laoreet dolore magna aliquam erat volutpat.</p>
			...
			<div class="item  col-xs-4 col-lg-4">
				<div class="thumbnail">
					<img class="group list-group-image" src="${images}/india.png"
						alt="" />
					<div class="caption">
						<h4 class="group inner list-group-item-heading">India</h4>
						<p class="group inner list-group-item-text">Product
							description... Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
							laoreet dolore magna aliquam erat volutpat.</p>
