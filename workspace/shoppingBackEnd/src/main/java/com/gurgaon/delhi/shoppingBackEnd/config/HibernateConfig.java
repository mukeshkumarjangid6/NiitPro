package com.gurgaon.delhi.shoppingBackEnd.config;
...
private final static String DATABASE_URL="jdbc:h2:tcp://localhost/~/mukesh";
...
public SessionFactory getSessionFactory(DataSource datasource)
{
	...
	builder.scanPackages("com.gurgaon.delhi.shoppingBackEnd.dto");
